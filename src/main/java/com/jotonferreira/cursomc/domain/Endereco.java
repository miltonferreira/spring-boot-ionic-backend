...
public class Endereco implements Serializable{
	...
	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)	//geração automatica de ID (chave primaria) das endereços
	private Integer id;
	...
	@ManyToOne						//Muitos para um = Muitos endereços para UMA cidade
	@JoinColumn(name="cidade_id")	//nome da chave estrangeira
	private Cidade cidade;			//Endereço conhece uma cidade
